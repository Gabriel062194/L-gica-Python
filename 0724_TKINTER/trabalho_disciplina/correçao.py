...
def calcular_resistencia(cor1, cor2, cor3):
    """Calcula o valor do resistor a partir das três primeiras faixas."""
...
class AplicacaoResistor:
    ...
    def criar_interface(self):
        ...
        subtitulo = tk.Label(
            self.root,
            text=(
                "Escolha um dos modos abaixo para calcular "
                "um resistor de quatro faixas"
            ),
            font=("Arial", 11),
            fg="#555555"
        )
        ...
        self.label_resultado = tk.Label(
            self.root,
            text="O resultado será exibido aqui",
            font=("Arial", 15, "bold"),
            fg="#111827"
        )
    ...
    def calcular_por_cores(self):
        ...
        try:
            ...
            texto_tolerancia = TOLERANCIAS[tolerancia]["texto"]


            self.label_resultado.config(
                text=(
                    f"Resistência: {texto_valor} "
                    f"{texto_tolerancia}"
                ),
                fg="#166534"
            )
        ...
        try:
            ...
            self.label_resultado.config(
                text=(
                    ...
                    f"{cor1} | {cor2} | {cor3} | "
                    f"{tolerancia} "
                    f"({TOLERANCIAS[tolerancia]['texto']})"
                ),
                fg="#166534"
            )
