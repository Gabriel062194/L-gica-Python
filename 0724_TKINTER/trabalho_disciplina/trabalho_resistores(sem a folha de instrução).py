...
DIGITOS = {
    ...
    "Branco": (9, "#FFFFFF")
     ...
     , 'Violeta': (7, '#EE82EE'), 'Cinza': (8, '#808080'),
    'Branco': (9, '#FFFFFF')
}
...
TOLERANCIAS = {
    ...
    'Azul': ('±0.25%', '#008000'), 'Violeta': ('±0.1%', '#EE82EE'), 'Ouro': ('±5%', '#D4AF37'),
    'Prata': ('±10%', '#C0C0C0')
}
...
# Criação das faixas coloridas (posição X1, Y1, X2, Y2)
...
# Variáveis do Tkinter para monitorar mudanças nos menus
...
# Adiciona rastreamento para atualizar o cálculo automaticamente ao mudar de cor
...
# Criando as etiquetas e os menus suspensos (Combobox)
